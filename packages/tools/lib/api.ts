/* eslint-disable */
import { CloudConfig, buildImageUrl, CldOptions, buildVideoUrl, TransformerOption, TransformerVideoOption, STORAGE_TYPES, setConfig } from 'cloudinary-build-url'
...
export class CloudinaryApi {
  ...
  get video (): VideoApi {
    const url = (publicId: string, options: CldOptions | CldOptionsImageLegacy = {}):string => { return buildVideoUrl(publicId, options as CldOptions) }
